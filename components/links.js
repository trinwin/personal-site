...
export default function Links() {
  ...
  return (
    <div className={utilStyles.links}>
      <a href="https://www.linkedin.com/in/trinwin" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      <a href="https://github.com/trinwin" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      <a href="mailto:thn.trinity@gmail.com" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      <a href="https://medium.com/@trinwin" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      <a href="https://twitter.com/_trinwin" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      <a href="https://www.instagram.com/_trinwin/" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
      ...
      {/* <a href="https://www.facebook.com/trinnwin" target="_blank">
        <svg
          role="img"
          width="40"
          viewBox="0 0 24 24"
